...
import com.wzy.reader.App
import com.wzy.reader.App.Companion.app
...
object DisplayUtil {
        ...
        try {
            ...
            if (result <= 0) // 双重校验
            {
                ...
                if (o != null) {
                    ...
                    result = app.resources.getDimensionPixelSize(x)
                }
            }
        } catch (_: Exception) {
        }
     ...
     * 判断当前设备是横屏还是竖屏。
     *
     * @return 1 横屏  2 竖屏   0 未知
     */
    fun getScreenOrientation(): Int {
        return when (App.context.resources.configuration.orientation) {
            Configuration.ORIENTATION_LANDSCAPE -> 1
            Configuration.ORIENTATION_PORTRAIT -> 2
            else -> 0 // 可能是方形屏幕或其他特殊情况
        }
    }
